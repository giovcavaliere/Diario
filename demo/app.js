...
const NUBEMO_DAILY_QUOTES=["Il tempo passa comunque: scegli cosa farne.","Una scelta coraggiosa può essere anche una scelta tranquilla.","Il coraggio non elimina la paura: le impedisce di decidere.","Il futuro si costruisce anche nei giorni normali.","Ogni giorno offre almeno una possibilità di scegliere meglio.","A volte può aprire una possibilità che ieri non vedevi: non sottovalutarlo.","Il tempo premia ciò che continui a coltivare.","Una scelta difficile può aprire una vita più semplice.","Il coraggio può avere una voce molto bassa.","Il futuro non chiede perfezione, chiede presenza.","Anche oggi può aprire una possibilità che ieri non vedevi: prova ancora.","La calma può aprire una possibilità che ieri non vedevi: prova ancora.","Il tempo non risolve tutto, ma dà spazio a molte risposte.","Una scelta di oggi può ringraziarti tra molto tempo.","Il coraggio può aprire una possibilità che ieri non vedevi: continua.","Il futuro può aprire una possibilità che ieri non vedevi: dagli spazio.","La costanza può aprire una possibilità che ieri non vedevi: vai avanti.","La determinazione può aprire una possibilità che ieri non vedevi.","Il tempo può aprire una possibilità che ieri non vedevi: lascia che faccia il suo lavoro.","La fiducia può aprire una possibilità che ieri non vedevi: fidati del prossimo passo.","La pazienza può aprire una possibilità che ieri non vedevi: scegli di esserci.","La strada può aprire una possibilità che ieri non vedevi: scegli di esserci.","Ogni cambiamento può aprire una possibilità che ieri non vedevi: vai avanti.","Ogni giorno può aprire una possibilità che ieri non vedevi.","Ogni inizio può aprire una possibilità che ieri non vedevi: non sottovalutarlo.","Ogni tentativo può aprire una possibilità che ieri non vedevi: continua.","Un passo può aprire una possibilità che ieri non vedevi: dagli spazio.","Una scelta può aprire una possibilità che ieri non vedevi: può bastare per oggi.","A volte conta più di quanto sembri: prova ancora.","Anche oggi conta più di quanto sembri.","Il coraggio conta più di quanto sembri: non sottovalutarlo.","Il futuro conta più di quanto sembri: scegli di esserci.","Il tempo conta più di quanto sembri: può bastare per oggi.","La calma conta più di quanto sembri.","La costanza conta più di quanto sembri: continua.","La determinazione conta più di quanto sembri: fidati del prossimo passo.","La fiducia conta più di quanto sembri: lascia che faccia il suo lavoro.","La pazienza conta più di quanto sembri: vai avanti.","La strada conta più di quanto sembri: vai avanti.","Ogni cambiamento conta più di quanto sembri: continua.","Ogni giorno conta più di quanto sembri: fidati del prossimo passo.","Ogni inizio conta più di quanto sembri: prova ancora.","Ogni tentativo conta più di quanto sembri: non sottovalutarlo.","Un passo conta più di quanto sembri: scegli di esserci.","Una scelta conta più di quanto sembri: dagli spazio.","A volte diventa forza quando scegli di continuare.","Anche oggi diventa forza quando scegli di continuare: fidati del prossimo passo.","Il coraggio diventa forza quando scegli di continuare: prova ancora.","Il futuro diventa forza quando scegli di continuare: vai avanti.","Il tempo diventa forza quando scegli di continuare: dagli spazio.","La calma diventa forza quando scegli di continuare: fidati del prossimo passo.","La costanza diventa forza quando scegli di continuare: non sottovalutarlo.","La determinazione diventa forza quando scegli di continuare: lascia che faccia il suo lavoro.","La fiducia diventa forza quando scegli di continuare: può bastare per oggi.","La pazienza diventa forza quando scegli di continuare: continua.","La strada diventa forza quando scegli di continuare: continua.","La volontà può aprire una possibilità che ieri non vedevi.","Ogni cambiamento diventa forza quando scegli di continuare: non sottovalutarlo.","Ogni giorno diventa forza quando scegli di continuare: lascia che faccia il suo lavoro.","Ogni inizio diventa forza quando scegli di continuare.","Ogni tentativo diventa forza quando scegli di continuare: prova ancora.","Un passo diventa forza quando scegli di continuare: vai avanti.","Una scelta diventa forza quando scegli di continuare: scegli di esserci.","A volte ti porta più lontano di uno slancio momentaneo: fidati del prossimo passo.","Anche oggi ti porta più lontano di uno slancio momentaneo: lascia che faccia il suo lavoro.","Il coraggio ti porta più lontano di uno slancio momentaneo.","Il futuro ti porta più lontano di uno slancio momentaneo: continua.","Il tempo ti porta più lontano di uno slancio momentaneo: scegli di esserci.","La calma ti porta più lontano di uno slancio momentaneo: lascia che faccia il suo lavoro.","La costanza ti porta più lontano di uno slancio momentaneo: prova ancora.","La determinazione ti porta più lontano di uno slancio momentaneo: può bastare per oggi.","La fiducia ti porta più lontano di uno slancio momentaneo: dagli spazio.","La pazienza ti porta più lontano di uno slancio momentaneo: non sottovalutarlo.","La strada ti porta più lontano di uno slancio momentaneo: non sottovalutarlo.","La volontà conta più di quanto sembri: fidati del prossimo passo.","Ogni cambiamento ti porta più lontano di uno slancio momentaneo: prova ancora.","Ogni giorno ti porta più lontano di uno slancio momentaneo: può bastare per oggi.","Ogni inizio ti porta più lontano di uno slancio momentaneo: fidati del prossimo passo.","Ogni tentativo ti porta più lontano di uno slancio momentaneo.","Un passo ti porta più lontano di uno slancio momentaneo: continua.","Una scelta ti porta più lontano di uno slancio momentaneo: vai avanti.","A volte cresce quando la metti alla prova: lascia che faccia il suo lavoro.","Anche oggi cresce quando la metti alla prova: può bastare per oggi.","Il coraggio cresce quando la metti alla prova: fidati del prossimo passo.","Il futuro cresce quando la metti alla prova: non sottovalutarlo.","Il tempo cresce quando la metti alla prova: vai avanti.","La calma cresce quando la metti alla prova: può bastare per oggi.","La costanza cresce quando la metti alla prova.","La determinazione cresce quando la metti alla prova: dagli spazio.","La fiducia cresce quando la metti alla prova: scegli di esserci.","La pazienza cresce quando la metti alla prova: prova ancora.","La strada cresce quando la metti alla prova: prova ancora.","La volontà diventa forza quando scegli di continuare: lascia che faccia il suo lavoro.","Ogni cambiamento cresce quando la metti alla prova.","Ogni giorno cresce quando la metti alla prova: dagli spazio.","Ogni inizio cresce quando la metti alla prova: lascia che faccia il suo lavoro.","Ogni tentativo cresce quando la metti alla prova: fidati del prossimo passo.","Un passo cresce quando la metti alla prova: non sottovalutarlo.","Una scelta cresce quando la metti alla prova: continua.","A volte ha bisogno di tempo per mostrare il suo valore: può bastare per oggi.","Anche oggi ha bisogno di tempo per mostrare il suo valore: dagli spazio.","Il coraggio ha bisogno di tempo per mostrare il suo valore: lascia che faccia il suo lavoro.","Il futuro ha bisogno di tempo per mostrare il suo valore: prova ancora.","Il tempo ha bisogno di tempo per mostrare il suo valore: continua.","La calma ha bisogno di tempo per mostrare il suo valore: dagli spazio.","La costanza ha bisogno di tempo per mostrare il suo valore: fidati del prossimo passo.","La determinazione ha bisogno di tempo per mostrare il suo valore: scegli di esserci.","La fiducia ha bisogno di tempo per mostrare il suo valore: vai avanti.","La pazienza ha bisogno di tempo per mostrare il suo valore.","La strada ha bisogno di tempo per mostrare il suo valore.","La volontà ti porta più lontano di uno slancio momentaneo: può bastare per oggi.","Le difficoltà cambiano forma quando cambi prospettiva.","Ogni cambiamento ha bisogno di tempo per mostrare il suo valore: fidati del prossimo passo.","Ogni giorno ha bisogno di tempo per mostrare il suo valore: scegli di esserci.","Ogni inizio ha bisogno di tempo per mostrare il suo valore: può bastare per oggi.","Ogni tentativo ha bisogno di tempo per mostrare il suo valore: lascia che faccia il suo lavoro.","Un passo ha bisogno di tempo per mostrare il suo valore: prova ancora.","Una scelta ha bisogno di tempo per mostrare il suo valore: non sottovalutarlo.","A volte può cambiare la direzione di tutto: dagli spazio.","Anche oggi può cambiare la direzione di tutto: scegli di esserci.","Gli errori può aprire una possibilità che ieri non vedevi: lascia che faccia il suo lavoro.","Il coraggio può cambiare la direzione di tutto: può bastare per oggi.","Il futuro può cambiare la direzione di tutto.","Il tempo può cambiare la direzione di tutto: non sottovalutarlo.","La calma può cambiare la direzione di tutto: scegli di esserci.","La costanza può cambiare la direzione di tutto: lascia che faccia il suo lavoro.","La determinazione può cambiare la direzione di tutto: vai avanti.","La fiducia può cambiare la direzione di tutto: continua.","La pazienza può cambiare la direzione di tutto: fidati del prossimo passo.","La strada può cambiare la direzione di tutto: fidati del prossimo passo.","La volontà cresce quando la metti alla prova: dagli spazio.","Le difficoltà può aprire una possibilità che ieri non vedevi: può bastare per oggi.","Le piccole decisioni può aprire una possibilità che ieri non vedevi: fidati del prossimo passo.","Ogni cambiamento può cambiare la direzione di tutto: lascia che faccia il suo lavoro.","Ogni giorno può cambiare la direzione di tutto: vai avanti.","Ogni inizio può cambiare la direzione di tutto: dagli spazio.","Ogni tentativo può cambiare la direzione di tutto: può bastare per oggi.","Un passo può cambiare la direzione di tutto.","Una scelta può cambiare la direzione di tutto: prova ancora.","A volte non deve essere perfetto per essere importante: scegli di esserci.","Anche oggi non deve essere perfetto per essere importante: vai avanti.","Gli errori conta più di quanto sembri: può bastare per oggi.","Il coraggio non deve essere perfetto per essere importante: dagli spazio.","Il futuro non deve essere perfetto per essere importante: fidati del prossimo passo.","Il tempo non deve essere perfetto per essere importante: prova ancora.","La calma non deve essere perfetto per essere importante: vai avanti.","La costanza non deve essere perfetto per essere importante: può bastare per oggi.","La determinazione non deve essere perfetto per essere importante: continua.","La fiducia non deve essere perfetto per essere importante: non sottovalutarlo.","La pazienza non deve essere perfetto per essere importante: lascia che faccia il suo lavoro.","La strada non deve essere perfetto per essere importante: lascia che faccia il suo lavoro.","La volontà ha bisogno di tempo per mostrare il suo valore: scegli di esserci.","Le difficoltà conta più di quanto sembri: dagli spazio.","Le piccole decisioni conta più di quanto sembri: lascia che faccia il suo lavoro.","Ogni cambiamento non deve essere perfetto per essere importante: può bastare per oggi.","Ogni giorno non deve essere perfetto per essere importante: continua.","Ogni inizio non deve essere perfetto per essere importante: scegli di esserci.","Ogni tentativo non deve essere perfetto per essere importante: dagli spazio.","Un passo non deve essere perfetto per essere importante: fidati del prossimo passo.","Una scelta non deve essere perfetto per essere importante.","A volte può insegnarti qualcosa che non avevi previsto: vai avanti.","Anche oggi può insegnarti qualcosa che non avevi previsto: continua.","Gli errori ti porta più lontano di uno slancio momentaneo: scegli di esserci.","Il coraggio può insegnarti qualcosa che non avevi previsto: scegli di esserci.","Il futuro può insegnarti qualcosa che non avevi previsto: lascia che faccia il suo lavoro.","Il tempo può insegnarti qualcosa che non avevi previsto.","La calma può insegnarti qualcosa che non avevi previsto: continua.","La costanza può insegnarti qualcosa che non avevi previsto: dagli spazio.","La determinazione può insegnarti qualcosa che non avevi previsto: non sottovalutarlo.","La fiducia può insegnarti qualcosa che non avevi previsto: prova ancora.","La pazienza può insegnarti qualcosa che non avevi previsto: può bastare per oggi.","La strada può insegnarti qualcosa che non avevi previsto: può bastare per oggi.","La volontà può cambiare la direzione di tutto: vai avanti.","Le difficoltà ti porta più lontano di uno slancio momentaneo: vai avanti.","Le piccole decisioni ti porta più lontano di uno slancio momentaneo: dagli spazio.","Ogni cambiamento può insegnarti qualcosa che non avevi previsto: dagli spazio.","Ogni giorno può insegnarti qualcosa che non avevi previsto: non sottovalutarlo.","Ogni inizio può insegnarti qualcosa che non avevi previsto: vai avanti.","Ogni tentativo può insegnarti qualcosa che non avevi previsto: scegli di esserci.","Un passo può insegnarti qualcosa che non avevi previsto: lascia che faccia il suo lavoro.","Una scelta può insegnarti qualcosa che non avevi previsto: fidati del prossimo passo.","A volte rende possibile ciò che sembrava troppo lontano: continua.","Anche oggi rende possibile ciò che sembrava troppo lontano: non sottovalutarlo.","Gli errori può cambiare la direzione di tutto: non sottovalutarlo.","Il coraggio rende possibile ciò che sembrava troppo lontano: vai avanti.","Il futuro rende possibile ciò che sembrava troppo lontano: può bastare per oggi.","Il tempo rende possibile ciò che sembrava troppo lontano: fidati del prossimo passo.","La calma rende possibile ciò che sembrava troppo lontano: non sottovalutarlo.","La costanza rende possibile ciò che sembrava troppo lontano: scegli di esserci.","La determinazione rende possibile ciò che sembrava troppo lontano: prova ancora.","La fiducia rende possibile ciò che sembrava troppo lontano.","La pazienza rende possibile ciò che sembrava troppo lontano: dagli spazio.","La strada rende possibile ciò che sembrava troppo lontano: dagli spazio.","La volontà non deve essere perfetto per essere importante: continua.","Le difficoltà può cambiare la direzione di tutto: prova ancora.","Le piccole decisioni può cambiare la direzione di tutto: continua.","Ogni cambiamento rende possibile ciò che sembrava troppo lontano: scegli di esserci.","Ogni giorno rende possibile ciò che sembrava troppo lontano: prova ancora.","Ogni inizio rende possibile ciò che sembrava troppo lontano: continua.","Ogni tentativo rende possibile ciò che sembrava troppo lontano: vai avanti.","Un passo rende possibile ciò che sembrava troppo lontano: può bastare per oggi.","Una scelta rende possibile ciò che sembrava troppo lontano: lascia che faccia il suo lavoro.","A volte si costruisce nelle scelte semplici: non sottovalutarlo.","Anche oggi si costruisce nelle scelte semplici: prova ancora.","Gli errori non deve essere perfetto per essere importante: prova ancora.","Il coraggio si costruisce nelle scelte semplici: continua.","Il futuro si costruisce nelle scelte semplici: dagli spazio.","Il tempo si costruisce nelle scelte semplici: lascia che faccia il suo lavoro.","La calma si costruisce nelle scelte semplici: prova ancora.","La costanza si costruisce nelle scelte semplici: vai avanti.","La determinazione si costruisce nelle scelte semplici.","La fiducia si costruisce nelle scelte semplici: fidati del prossimo passo.","La pazienza si costruisce nelle scelte semplici: scegli di esserci.","La strada si costruisce nelle scelte semplici: scegli di esserci.","La volontà può insegnarti qualcosa che non avevi previsto: non sottovalutarlo.","Le difficoltà non deve essere perfetto per essere importante.","Le piccole decisioni non deve essere perfetto per essere importante: non sottovalutarlo.","Ogni cambiamento si costruisce nelle scelte semplici: vai avanti.","Ogni giorno si costruisce nelle scelte semplici.","Ogni inizio si costruisce nelle scelte semplici: non sottovalutarlo.","Ogni tentativo si costruisce nelle scelte semplici: continua.","Un passo si costruisce nelle scelte semplici: dagli spazio.","Una scelta si costruisce nelle scelte semplici: può bastare per oggi.","A volte può trasformare un limite in un nuovo punto di partenza: prova ancora.","Anche oggi può trasformare un limite in un nuovo punto di partenza.","Gli errori può insegnarti qualcosa che non avevi previsto.","Il coraggio può trasformare un limite in un nuovo punto di partenza: non sottovalutarlo.","Il futuro può trasformare un limite in un nuovo punto di partenza: scegli di esserci.","Il tempo può trasformare un limite in un nuovo punto di partenza: può bastare per oggi.","La calma può trasformare un limite in un nuovo punto di partenza.","La costanza può trasformare un limite in un nuovo punto di partenza: continua.","La determinazione può trasformare un limite in un nuovo punto di partenza: fidati del prossimo passo.","La fiducia può trasformare un limite in un nuovo punto di partenza: lascia che faccia il suo lavoro.","La pazienza può trasformare un limite in un nuovo punto di partenza: vai avanti.","La strada può trasformare un limite in un nuovo punto di partenza: vai avanti.","La volontà rende possibile ciò che sembrava troppo lontano: prova ancora.","Le difficoltà può insegnarti qualcosa che non avevi previsto: fidati del prossimo passo.","Le piccole decisioni può insegnarti qualcosa che non avevi previsto: prova ancora.","Ogni cambiamento può trasformare un limite in un nuovo punto di partenza: continua.","Ogni giorno può trasformare un limite in un nuovo punto di partenza: fidati del prossimo passo.","Ogni inizio può trasformare un limite in un nuovo punto di partenza: prova ancora.","Ogni tentativo può trasformare un limite in un nuovo punto di partenza: non sottovalutarlo.","Un passo può trasformare un limite in un nuovo punto di partenza: scegli di esserci.","Una scelta può trasformare un limite in un nuovo punto di partenza: dagli spazio.","A volte vale soprattutto quando sarebbe più facile rinunciare.","Anche oggi vale soprattutto quando sarebbe più facile rinunciare: fidati del prossimo passo.","Gli errori rende possibile ciò che sembrava troppo lontano: fidati del prossimo passo.","Il coraggio vale soprattutto quando sarebbe più facile rinunciare: prova ancora.","Il futuro vale soprattutto quando sarebbe più facile rinunciare: vai avanti.","Il tempo vale soprattutto quando sarebbe più facile rinunciare: dagli spazio.","La calma vale soprattutto quando sarebbe più facile rinunciare: fidati del prossimo passo.","La costanza vale soprattutto quando sarebbe più facile rinunciare: non sottovalutarlo.","La determinazione vale soprattutto quando sarebbe più facile rinunciare: lascia che faccia il suo lavoro.","La fiducia vale soprattutto quando sarebbe più facile rinunciare: può bastare per oggi.","La pazienza vale soprattutto quando sarebbe più facile rinunciare: continua.","La strada vale soprattutto quando sarebbe più facile rinunciare: continua.","La volontà si costruisce nelle scelte semplici.","Le difficoltà rende possibile ciò che sembrava troppo lontano: lascia che faccia il suo lavoro.","Le piccole decisioni rende possibile ciò che sembrava troppo lontano.","Ogni cambiamento vale soprattutto quando sarebbe più facile rinunciare: non sottovalutarlo.","Ogni giorno vale soprattutto quando sarebbe più facile rinunciare: lascia che faccia il suo lavoro.","Ogni inizio vale soprattutto quando sarebbe più facile rinunciare.","Ogni tentativo vale soprattutto quando sarebbe più facile rinunciare: prova ancora.","Un passo vale soprattutto quando sarebbe più facile rinunciare: vai avanti.","Una scelta vale soprattutto quando sarebbe più facile rinunciare: scegli di esserci.","A volte può sorprenderti se le lasci spazio: fidati del prossimo passo.","Anche oggi può sorprenderti se le lasci spazio: lascia che faccia il suo lavoro.","Gli errori può trasformare un limite in un nuovo punto di partenza: può bastare per oggi.","Il coraggio può sorprenderti se le lasci spazio.","Il futuro può sorprenderti se le lasci spazio: continua.","Il tempo può sorprenderti se le lasci spazio: scegli di esserci.","La calma può sorprenderti se le lasci spazio: lascia che faccia il suo lavoro.","La costanza può sorprenderti se le lasci spazio: prova ancora.","La determinazione può sorprenderti se le lasci spazio: può bastare per oggi.","La fiducia può sorprenderti se le lasci spazio: dagli spazio.","La pazienza può sorprenderti se le lasci spazio: non sottovalutarlo.","La strada può sorprenderti se le lasci spazio: non sottovalutarlo.","La volontà può trasformare un limite in un nuovo punto di partenza: fidati del prossimo passo.","Le difficoltà può trasformare un limite in un nuovo punto di partenza: dagli spazio.","Le piccole decisioni può trasformare un limite in un nuovo punto di partenza: lascia che faccia il suo lavoro.","Ogni cambiamento può sorprenderti se le lasci spazio: prova ancora.","Ogni giorno può sorprenderti se le lasci spazio: può bastare per oggi.","Ogni inizio può sorprenderti se le lasci spazio: fidati del prossimo passo.","Ogni tentativo può sorprenderti se le lasci spazio.","Un passo può sorprenderti se le lasci spazio: continua.","Una scelta può sorprenderti se le lasci spazio: vai avanti.","A volte diventa più chiaro quando inizi a muoverti: lascia che faccia il suo lavoro.","Anche oggi diventa più chiaro quando inizi a muoverti: può bastare per oggi.","Gli errori vale soprattutto quando sarebbe più facile rinunciare: dagli spazio.","Il coraggio diventa più chiaro quando inizi a muoverti: fidati del prossimo passo.","Il futuro diventa più chiaro quando inizi a muoverti: non sottovalutarlo.","Il tempo diventa più chiaro quando inizi a muoverti: vai avanti.","La calma diventa più chiaro quando inizi a muoverti: può bastare per oggi.","La costanza diventa più chiaro quando inizi a muoverti.","La determinazione diventa più chiaro quando inizi a muoverti: dagli spazio.","La fiducia diventa più chiaro quando inizi a muoverti: scegli di esserci.","La pazienza diventa più chiaro quando inizi a muoverti: prova ancora.","La strada diventa più chiaro quando inizi a muoverti: prova ancora.","La volontà vale soprattutto quando sarebbe più facile rinunciare: lascia che faccia il suo lavoro.","Le difficoltà vale soprattutto quando sarebbe più facile rinunciare: scegli di esserci.","Le piccole decisioni vale soprattutto quando sarebbe più facile rinunciare: può bastare per oggi.","Ogni cambiamento diventa più chiaro quando inizi a muoverti.","Ogni giorno diventa più chiaro quando inizi a muoverti: dagli spazio.","Ogni inizio diventa più chiaro quando inizi a muoverti: lascia che faccia il suo lavoro.","Ogni tentativo diventa più chiaro quando inizi a muoverti: fidati del prossimo passo.","Un passo diventa più chiaro quando inizi a muoverti: non sottovalutarlo.","Una scelta diventa più chiaro quando inizi a muoverti: continua.","A volte non chiede velocità, ma presenza: può bastare per oggi.","Anche oggi non chiede velocità, ma presenza: dagli spazio.","Gli errori può sorprenderti se le lasci spazio: scegli di esserci.","Il coraggio non chiede velocità, ma presenza: lascia che faccia il suo lavoro.","Il futuro non chiede velocità, ma presenza: prova ancora.","Il tempo non chiede velocità, ma presenza: continua.","La calma non chiede velocità, ma presenza: dagli spazio.","La costanza non chiede velocità, ma presenza: fidati del prossimo passo.","La determinazione non chiede velocità, ma presenza: scegli di esserci.","La fiducia non chiede velocità, ma presenza: vai avanti.","La pazienza non chiede velocità, ma presenza.","La strada non chiede velocità, ma presenza.","La volontà può sorprenderti se le lasci spazio: può bastare per oggi.","Le difficoltà può sorprenderti se le lasci spazio: vai avanti.","Le piccole decisioni può sorprenderti se le lasci spazio: dagli spazio.","Ogni cambiamento non chiede velocità, ma presenza: fidati del prossimo passo.","Ogni giorno non chiede velocità, ma presenza: scegli di esserci.","Ogni inizio non chiede velocità, ma presenza: può bastare per oggi.","Ogni tentativo non chiede velocità, ma presenza: lascia che faccia il suo lavoro.","Un passo non chiede velocità, ma presenza: prova ancora.","Una scelta non chiede velocità, ma presenza: non sottovalutarlo.","A volte può essere l'inizio di qualcosa di migliore: dagli spazio.","Anche oggi può essere l'inizio di qualcosa di migliore: scegli di esserci.","Ciò che ripeti diventa parte di ciò che sei.","Gli errori non chiede velocità, ma presenza: continua.","Il coraggio può essere l'inizio di qualcosa di migliore: può bastare per oggi.","Il futuro può essere l'inizio di qualcosa di migliore.","Il tempo può essere l'inizio di qualcosa di migliore: non sottovalutarlo.","La calma può essere l'inizio di qualcosa di migliore: scegli di esserci.","La costanza può essere l'inizio di qualcosa di migliore: lascia che faccia il suo lavoro.","La determinazione può essere l'inizio di qualcosa di migliore: vai avanti.","La fiducia può essere l'inizio di qualcosa di migliore: continua.","La pazienza può essere l'inizio di qualcosa di migliore: fidati del prossimo passo.","La strada può essere l'inizio di qualcosa di migliore: fidati del prossimo passo.","La volontà diventa più chiaro quando inizi a muoverti: dagli spazio.","Le difficoltà non chiede velocità, ma presenza: non sottovalutarlo.","Le piccole decisioni non chiede velocità, ma presenza: vai avanti.","Ogni cambiamento può essere l'inizio di qualcosa di migliore: lascia che faccia il suo lavoro.","Ogni giorno può essere l'inizio di qualcosa di migliore: vai avanti.","Ogni inizio può essere l'inizio di qualcosa di migliore: dagli spazio.","Ogni tentativo può essere l'inizio di qualcosa di migliore: può bastare per oggi.","Un passo può essere l'inizio di qualcosa di migliore.","Una scelta può essere l'inizio di qualcosa di migliore: prova ancora.","A volte si rafforza ogni volta che riprovi: scegli di esserci.","Anche oggi si rafforza ogni volta che riprovi: vai avanti.","Ciò che conta merita tempo.","Gli errori può essere l'inizio di qualcosa di migliore: non sottovalutarlo.","Il coraggio si rafforza ogni volta che riprovi: dagli spazio.","Il futuro si rafforza ogni volta che riprovi: fidati del prossimo passo.","Il tempo si rafforza ogni volta che riprovi: prova ancora.","La calma si rafforza ogni volta che riprovi: vai avanti.","La costanza si rafforza ogni volta che riprovi: può bastare per oggi.","La determinazione si rafforza ogni volta che riprovi: continua.","La fiducia si rafforza ogni volta che riprovi: non sottovalutarlo.","La pazienza si rafforza ogni volta che riprovi: lascia che faccia il suo lavoro.","La strada si rafforza ogni volta che riprovi: lascia che faccia il suo lavoro.","La volontà non chiede velocità, ma presenza: scegli di esserci.","Le difficoltà può essere l'inizio di qualcosa di migliore: prova ancora.","Le piccole decisioni può essere l'inizio di qualcosa di migliore: continua.","Non aspettare di sentirti pronto per iniziare.","Ogni cambiamento si rafforza ogni volta che riprovi: può bastare per oggi.","Ogni giorno si rafforza ogni volta che riprovi: continua.","Ogni inizio si rafforza ogni volta che riprovi: scegli di esserci.","Non devi dimostrare tutto in un solo giorno.","Ogni tentativo si rafforza ogni volta che riprovi: dagli spazio.","Quello che costruisci lentamente può durare a lungo.","Un passo si rafforza ogni volta che riprovi: fidati del prossimo passo.","Non serve sapere tutto per fare il prossimo passo.","Una scelta si rafforza ogni volta che riprovi.","A volte non cancella la fatica, ma le dà una direzione: vai avanti.","Anche oggi non cancella la fatica, ma le dà una direzione: continua.","Non tutto deve riuscire al primo tentativo.","Ci sono giorni per correre e giorni per resistere.","Ciò che oggi richiede coraggio domani potrebbe sembrarti naturale.","Gli errori non cancella la fatica, ma le dà una direzione.","Il coraggio non cancella la fatica, ma le dà una direzione: scegli di esserci.","Il futuro non cancella la fatica, ma le dà una direzione: lascia che faccia il suo lavoro.","Il tempo non cancella la fatica, ma le dà una direzione.","La calma non cancella la fatica, ma le dà una direzione: continua.","La costanza non cancella la fatica, ma le dà una direzione: dagli spazio.","La determinazione non cancella la fatica, ma le dà una direzione: non sottovalutarlo.","La fiducia non cancella la fatica, ma le dà una direzione: prova ancora.","La pazienza non cancella la fatica, ma le dà una direzione: può bastare per oggi.","La strada non cancella la fatica, ma le dà una direzione: può bastare per oggi.","La volontà può essere l'inizio di qualcosa di migliore: vai avanti.","Le difficoltà non cancella la fatica, ma le dà una direzione: fidati del prossimo passo.","Le giornate lente fanno comunque parte del viaggio.","Le piccole decisioni non cancella la fatica, ma le dà una direzione: prova ancora.","Non aspettare una certezza che nessuno può darti.","Ogni cambiamento non cancella la fatica, ma le dà una direzione: dagli spazio.","Ogni giorno non cancella la fatica, ma le dà una direzione: non sottovalutarlo.","Ogni inizio non cancella la fatica, ma le dà una direzione: vai avanti.","Non devi vincere ogni giorno: devi continuare a partecipare.","Ogni tentativo non cancella la fatica, ma le dà una direzione: scegli di esserci.","Ogni volta che riprovi, parti con qualcosa in più.","Puoi cambiare strada senza rinunciare alla destinazione.","Non lasciare che un dubbio prenda tutte le decisioni.","Quello che impari resta anche quando il risultato tarda.","Un passo non cancella la fatica, ma le dà una direzione: lascia che faccia il suo lavoro.","Puoi essere stanco e continuare a credere in ciò che vuoi.","Non serve fare rumore per fare strada.","Una scelta non cancella la fatica, ma le dà una direzione: fidati del prossimo passo.","A volte può portarti dove non pensavi di arrivare: continua.","Anche oggi può portarti dove non pensavi di arrivare: non sottovalutarlo.","Non tutte le vittorie fanno rumore.","Anche una strada lunga comincia da una decisione breve.","Ci sono progressi che si riconoscono solo guardando indietro.","Ciò che fai spesso conta più di ciò che fai eccezionalmente.","Non tutto ciò che tarda è perduto.","Cominciare piano è sempre meglio che restare fermi.","Continua a costruire anche quando non si vede ancora il risultato.","Essere costanti vale più che essere impeccabili.","Fai bene ciò che puoi fare oggi.","Fidati anche della persona che stai diventando.","Gli errori può portarti dove non pensavi di arrivare: fidati del prossimo passo.","Essere determinati significa anche saper cambiare metodo.","Fai pace con il tempo necessario.","Il cambiamento comincia quando una scelta diventa un'azione.","Il coraggio può portarti dove non pensavi di arrivare: vai avanti.","Essere pazienti non significa smettere di avanzare.","Fai spazio a ciò che vuoi diventare.","Il domani non è obbligato a ripetere oggi.","Il dubbio può viaggiare con te, ma non deve guidare.","Il futuro può portarti dove non pensavi di arrivare: può bastare per oggi.","Il modo in cui riparti conta più del modo in cui sei caduto.","Il momento perfetto raramente manda un invito.","Il primo passo non deve conoscere l'ultimo.","Il prossimo capitolo non deve assomigliare al precedente.","Il successo non ha bisogno di essere immediato per essere reale.","Il tempo può portarti dove non pensavi di arrivare: fidati del prossimo passo.","Il tuo prossimo passo non deve essere spettacolare, solo vero.","Il valore di una scelta si vede spesso col tempo.","La calma può portarti dove non pensavi di arrivare: non sottovalutarlo.","La costanza può portarti dove non pensavi di arrivare: scegli di esserci.","La determinazione può portarti dove non pensavi di arrivare: prova ancora.","La direzione conta più della velocità.","La fiducia può portarti dove non pensavi di arrivare.","La pazienza può portarti dove non pensavi di arrivare: dagli spazio.","La strada può portarti dove non pensavi di arrivare: dagli spazio.","La volontà si rafforza ogni volta che riprovi: continua.","Lascia al futuro la possibilità di sorprenderti.","Le cose importanti raramente crescono in fretta.","Le difficoltà può portarti dove non pensavi di arrivare: lascia che faccia il suo lavoro.","Le giornate storte non hanno diritto di voto sul tuo futuro.","Lascia andare ciò che non puoi cambiare e usa ciò che puoi.","Le grandi svolte spesso iniziano da decisioni silenziose.","Le occasioni migliori a volte sembrano semplici decisioni.","Le piccole decisioni può portarti dove non pensavi di arrivare.","Lascia che i risultati abbiano il tempo di maturare.","Le possibilità aumentano quando smetti di aspettare la perfezione.","Le risposte arrivano più facilmente quando inizi a fare domande.","Non aspettare che spariscano i dubbi per muoverti.","Ogni cambiamento può portarti dove non pensavi di arrivare: scegli di esserci.","Ogni esperienza aggiunge qualcosa alla tua prossima decisione.","Ogni giorno può portarti dove non pensavi di arrivare: prova ancora.","Non avere fretta di diventare ciò che richiede tempo.","Ogni inizio può portarti dove non pensavi di arrivare: continua.","Ogni scelta consapevole lascia una traccia.","Ogni tentativo può portarti dove non pensavi di arrivare: vai avanti.","Non confondere una pausa con una resa.","Ogni traguardo è stato prima una possibilità.","Ogni volta che scegli di continuare, qualcosa cambia.","Puoi avere paura e scegliere comunque di provarci.","Non devi avere tutte le risposte per meritare un nuovo inizio.","Quando non puoi fare molto, fai bene quel poco.","Quello che sembra lento può essere semplicemente solido.","Puoi cambiare ritmo senza cambiare obiettivo.","Non hai bisogno di impressionare nessuno per andare avanti.","Quando una strada finisce, resta la possibilità di sceglierne un'altra.","Ricominciare è una capacità, non una sconfitta.","Puoi costruire molto anche senza vedere subito il risultato.","Non lasciare che la fretta scelga al posto tuo.","Se una porta non si apre, puoi ancora scegliere un'altra direzione.","Un errore può indicare una strada migliore.","Puoi essere prudente senza rinunciare ad essere coraggioso.","Non misurare il futuro con le difficoltà di oggi.","Un giorno difficile non decide come finirà la storia.","Un limite può essere un confine oppure un punto da esplorare.","Puoi imparare anche da ciò che non è andato come volevi.","Non perdere energia cercando di controllare ciò che non dipende da te.","Un obiettivo lontano si avvicina un giorno alla volta.","Un passo può portarti dove non pensavi di arrivare: può bastare per oggi.","Un piccolo progresso cambia comunque la distanza.","Non serve correre per essere in movimento.","Una battuta d'arresto non cancella la strada fatta.","Una buona direzione rende utile anche un passo piccolo.","Una decisione presa con calma può cambiare molto.","Non smettere di cercare una strada solo perché la prima era chiusa.","Una nuova possibilità può iniziare da un semplice sì.","Una scelta può portarti dove non pensavi di arrivare: lascia che faccia il suo lavoro.","Non sottovalutare la forza delle abitudini semplici.","Non tutte le giornate devono essere memorabili per essere utili.","Non tutto ciò che vale si vede subito."];
